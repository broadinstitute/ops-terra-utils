...
def test_get_filesize() -> None:
    ...
    GCPCloudFunctions().get_filesize(target_path=target_path)
...
def test_multithread_copy_of_files_with_validation() -> None:
    ...
    ouput_path = cloud_resources['bucket'] + "/tmp/multi_copy/"
    input_dict_list = [
        {"source_file": test_files[0], "full_destination_path": ouput_path},
        {"source_file": test_files[1], "full_destination_path": ouput_path}
    ]
...
def test_move_or_copy_multiple_files() -> None:
    ...
    def run_copy_test() -> None:
        input_dict_list = [
            {"source_file": test_files[0], "full_destination_path": ouput_copy_path},
            {"source_file": test_files[1], "full_destination_path": ouput_copy_path}
        ]
    ...
    def run_mv_test() -> None:
        input_dict_list = [
            {"source_file": test_files[0], "full_destination_path": output_mv_path},
            {"source_file": test_files[1], "full_destination_path": output_mv_path}
        ]
