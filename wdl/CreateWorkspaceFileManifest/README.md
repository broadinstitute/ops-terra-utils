...
| **include_external_files**      | Whether to include external files when listing files from this bucket. By default, external files are not included.                                                                                                                                                     | Boolean | No        | false     |
...
| **additional_external_paths**   | List of additional external paths to include. Can be GCP buckets, directories, or files. If it does not end in a / it will assume it is a file.                                                                                                                         | String  | No        | N/A       |
