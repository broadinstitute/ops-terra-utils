...
- [ ] The [Terra workflow configs](python/utils/terra_utils/terra_workflow_configs.py) file has been updated so that your new workflow can be imported via our scripts. First define the workflow as one that is available for import ([here](https://github.com/broadinstitute/ops-terra-utils/blob/9dce77c727e76f83389ae7312aeaab6890503533/python/utils/terra_utils/terra_workflow_configs.py#L14)) and then define the configuration parameters (see [CopyDataset](https://github.com/broadinstitute/ops-terra-utils/blob/9dce77c727e76f83389ae7312aeaab6890503533/python/utils/terra_utils/terra_workflow_configs.py#L64C9-L64C20) as an example).
